                            ...
                            <form
                                ...
                                <div className="grid gap-4 mb-4 grid-cols-2">
                                    ...
                                    <div className="col-span-2">
                                        ...
                                        <input type="number" name="balance" id="balance" className="bg-gray-50 border border-gray-300  text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5  dark:border-gray-500 dark:placeholder-gray-400  dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="$2999" defaultValue ={item.balance}/>
                                    </div>
                                    <div className="col-span-2">
